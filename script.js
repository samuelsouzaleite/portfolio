...
const translations = {
    pt: {
        ...
        project_escola_title: "API de Escola",
        project_escola_desc: "API REST de gestão escolar em C# e .NET, com cursos, turmas, matrículas, notas e autenticação JWT.",
        tech_mobile: "Mobile",
    ...
    en: {
        ...
        project_escola_title: "School API",
        project_escola_desc: "School management REST API in C# and .NET, with courses, classes, enrollments, grades and JWT authentication.",
        tech_mobile: "Mobile",
